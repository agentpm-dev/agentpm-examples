...
The generated root agent also carries the published Loop package:
...
The generated root agent also carries the published Profile package:
...
It also prints the installed Loop, Knowledge, Memory, and Profile package details so you can confirm the template-driven dependencies were resolved correctly.

...
summarize_tool = load("@zack/summarize-text@0.1.5", with_meta=True, env={ "OPENAI_API_KEY": OPENAI_API_KEY })
translate_tool = load("@zack/translate-text@0.1.2", with_meta=True, env={ "OPENAI_API_KEY": OPENAI_API_KEY })
